...
const config: Config = {
    ...
    // Чтобы на маке и на windows запускалось правильно
    ...
    // should be collected collectCoverageFrom: undefined,
    ...
    // worker number. maxWorkers: 2 will use a maximum of 2 workers. maxWorkers: "50%",
    ...
    // re-running tests in watch mode watchPathIgnorePatterns: [],
