...
const profile: Profile = {
    ...
    city: 'Moscow',
    username: 'admin213',
    avatar: 'https://ovicio.com.br/wp-content/uploads/2023/01/20230102-flblag-xgaaclax-555x555.jpg',
};
...
describe('feutures/EditableProfileCard', () => {
    test('Readonly change success', async () => {
    ...
    test('Validation success -> put to api', async () => {
